        ...
        <div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{route('admin.service.store')}}" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-5">
                        <input class="form-control price" type="number" value="{{ old('fixed') }}" name="fixed" required id="fixed" placeholder="Base Price" min="0">
                    </div>
                    <div class="col-xs-5">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-5">
                        <input class="form-control price" type="number" value="{{ old('minute') }}" name="minute" required id="minute" placeholder="Unit Time Pricing" min="0">
                    </div>
                    <div class="col-xs-5">
